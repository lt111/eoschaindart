...
Binargs _$BinargsFromJson(Map<String, dynamic> json) {
  return Binargs()
    ..binargs = json['binargs'];
}

Map<String, dynamic> _$BinargsToJson(Binargs instance) =>
    <String, dynamic>{'binargs': instance.binargs};
